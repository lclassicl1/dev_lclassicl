...
<body>
	<h1>JSP Display date</h1>
	<p id="date"></p>
		<pre>
			js에서 date객체는 자동적으로 toString() 객체가 호출되어 String으로 변환하여 출력된다
		</pre>
		<script>
			document.write("<pre>");
			...
			document.writeln('new Date().toString ='+today.toUTCString());
			...
			document.write('getDay=>'+today.getDay()+'<br/>'); /* day도 일요일부터 0으로나타냄 0~6까지의 수가 나옴 따라서 switch문으로 한글화*/
